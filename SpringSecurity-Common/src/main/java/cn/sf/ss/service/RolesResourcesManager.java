...
import cn.sf.ss.dao.RolesResourcesDao;
...
public class RolesResourcesManager extends BaseManager<RolesResources,java.lang.String>{
	...
	public List<Resources> findByPage(HttpServletRequest request) {
		...
		sqlWhere += " and "+ Resources.rs_pk_resource +" not in (select resourceId from cn.sf.ss.model.RolesResources where roleId='" + role.getId() + "')";
		int start = 0;
		long requestPage = 1;
		int pageSize = 20;
