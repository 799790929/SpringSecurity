...
<div id="right_box">
        	<!-- <h3>车辆库存</h3> -->
          <!-- <div id="search_div">
            资源名<input name="" type="text" class="input_a" /><input type="button" class="btn_a" value="查询" />
          </div> -->
          
          <div id="main_h4">权限列表</div>
          <div id="main_btn">
          	<%-- <a href="${ctx}/ss/Resources/doSavePage.do" class="type_a"><div id="btn_2">+新增权限</div></a> --%>
          	<%-- <a href="javascript:addResourcePage('${ctx}/ss/Resources/doSavePage.do')" class="type_a"><div id="btn_2">+新增权限</div></a> --%>
