...
<div id="right_box">
          ...
          <div id="main_h4">新增角色</div>
          <div id="main_btn">
          	<a href="javascript:history.go(-1)" class="type_a"><div id="btn_2">返回</div></a>
          </div>
            
            <div id="content">
            	<form action="${ctx}/ss/Roles/doSave.do" method="post" id="form" name="form">
	            	<table width="100%" border="0"cellspacing="1" cellpadding="0"  style='background-color:#e2e2e2'>
                      <tr>
                      	<td align="center" bgcolor="#e3e3e3">角色名</td><td><input type="text" name="name"/></td>
                      </tr>
                      <!-- <tr>
