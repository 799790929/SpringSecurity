...
<div id="right_box">
          ...
          <div id="main_btn">
          	<%-- <a href="${ctx}/ss/Groups/doSavePage.do" class="type_a"><div id="btn_2">+新增群组</div></a> --%>
          	<%-- <a href="javascript:addGroupPage('${ctx}/ss/Groups/doSavePage.do')" class="type_a"><div id="btn_2">+新增群组</div></a> --%>
