	...
	function doPage(requestPage){
		...
		//$("#doSearch").submit();
     	...
     	<div id="right_box">
          ...
          <div id="main_btn">
          	<%-- <a href="${ctx }/ss/GroupsRoles/doSavePage.do?roleid=${role.id}" class="type_a"><div id="btn_2">+分配群组</div></a> --%>
          	<%-- <a href="javascript:addPage('${ctx }/ss/GroupsRoles/doSavePage.do?roleid=${role.id}')" class="type_a"><div id="btn_2">+分配群组</div></a> --%>
